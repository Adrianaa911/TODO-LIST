...
3. The 'deleteAllTasks' button was used incorrectly, didn't worked and had to fix it. I was still calling the function instead of passing it,
like this: 'deleteButton.addEventListener("click", deleteAllTasks());'.
